...
#
# RAM ends at FFFFh, so the load address bounds how large a model can be. At
# 8000h only 32,768 bytes are available, which both shipped examples exceed.
# 6000h is the lowest address clear of the screen (4000-5AFFh), the printer
# buffer (5B00-5BFFh) and the system variables (5C00-5CCAh), and leaves room
# below it for the BASIC loader once RAMTOP is moved down with CLEAR. That
# gives 40,960 bytes.
ORG_ADDR = 0x6000
